...
ALL_APPS = ['ActivityDiary', 'chess','AmazeFileManager', 'and-bible', 'AnkiDroid', 'APhotoManager', 'commons',
            ...
            'sunflower', 'WordPress', "AntennaPod", "newpipe", 'duckduckgo', 'RedReader', 'owntracks', 'myExpenses', 'bookdash', 'Wikipedia',
              'kotatsu', 'aard2','alarm']
    ...
    for ec_file in coverage_ec_files:
        ...
        if not os.path.exists(merged_coverage_ec_file_path):
            ...
            try:
                ...
                # clear the output
                output = p.communicate()[0].decode('utf-8', errors='ignore').strip()
                print(output)
...
def compute_code_coverage(app_name, tool_name, testing_result_dir, coverage_data_dir, index):
    ...
    xml_coverage_report_file_path = os.path.join(testing_result_dir, f"coverage_report{index}.xml")
...
def compute_single_code_coverage(target_app_testing_result_dirs):
    ...
    for index,tmp_dir in enumerate(coverage_ec_files):
        ...
        is_valid_data, line_coverage, branch_coverage, method_coverage, class_coverage = \
            compute_code_coverage(app_name, tool_name, target_app_testing_result_dirs, coverage_data_dir, index)
    ...
    for coverage_ec_file in average_coverage_dict:
        file_id = coverage_ec_file.split("_all_")[1].split(".ec")[0]
        ...
        with open(coverage_data_summary_file_path, "a") as csv_file:
            ...
            writer.writerow(
                [app_name, file_id,coverage_ec_file, average_line_coverage, average_branch_coverage, average_method_coverage,
